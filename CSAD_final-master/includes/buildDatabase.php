...
function buildDatabase() {
     // Crucial variable for connecting with database
    ...
    $dbExists = $conn->query("SELECT SCHEMA_NAME FROM INFORMATION_SCHEMA.SCHEMATA WHERE SCHEMA_NAME = 'stockPulse'");
    ...
    if ($dbExists->num_rows == 0) {
        ...
        CREATE TABLE watchlist (
            watchlistId INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
            userId INT,
        ...
        CREATE TABLE orderActions (
            orderActionId INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
            orderActionName VARCHAR(45) NOT NULL
        );

        INSERT INTO orderActions (orderActionName) VALUES
        ('Buy'),
        ('Sell');
